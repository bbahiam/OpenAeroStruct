        ...
        for surface in surfList:
            ...
            for aileron in ailList:
                ...
                for q_psf, cl_del_true in dcl_ddelta_data[surfname][aileron['name']]: # iterate lines
                    with self.subTest(q_psf=q_psf, wing=surfname, aileron=aileron['name']):
                        q_pa = q_psf*47.8803
                        ...
                        self.assertTrue(abs(cl_del-cl_del_true) < 6e-4,  # resolution of the report data is ~1e-4
